...
export default function SignUp() {
  ...
  const handleManualSignUp = async (e) => {
    ...
    try {
      ...
      setSuccessMessage('Account created successfully! Welcome to UpSkillr.');
    ...
    <div className={`signup-page ${theme}-mode`}>
      ...
      <main className="signup-container">
        ...
        <section className="signup-left">
          ...
          {/* Detailed SVG Illustration matching reference image */}
          <div className="illustration-wrapper">
            <svg className="illustration-svg" viewBox="0 0 500 380" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              {/* Floating Node 1: Graduation Cap */}
